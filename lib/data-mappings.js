...
export function getQuestionKey(question) {
  const slug = question?.fields.Slug;
  // Ensure the key starts with a letter, needed for creating an anchor link
  return /^[a-z]/.test(slug) ? slug : `q-${slug}`;
}
