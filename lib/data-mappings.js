import { RESPONSES_AUTHORS, authorsMap } from "@/lib/constants";
...
export function isQuestionInThematique(question, thematique) {
  return getQuestionThematiqueId(question) == getThematiqueId(thematique);
}

export function getQuestionPageLink(thematique, question) {
  return `/${getThematiqueKey(thematique)}#question_${getQuestionId(question)}`;
}
